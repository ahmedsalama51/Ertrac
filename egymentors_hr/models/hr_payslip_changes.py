...
class HrPayslipRun(models.Model):
	...
	def generate_hr_payslip_by_employees(self):
		...
		for rec in self:
			...
			if rec.all_employees:
				...
				domain.append(('work_location_id.all_employees_exclude', '=', False))
			else:
				domain.append(('work_location_id', '=', rec.work_location_id.id))
			...
			return {
				...
				'target': 'new',
				'context': {'default_employee_ids': [(6, 0, emp_ids.ids)]}
			}
